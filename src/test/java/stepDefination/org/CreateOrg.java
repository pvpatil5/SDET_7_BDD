...
public class CreateOrg 
{
	...
	public void enterorgname(String anything) {
		driver.findElement(By.className("accountname")).sendKeys(anything);
	}

	@Then("enter phonenumber {string}")
	public void enter_phonenumber(String phonenumber) {
		driver.findElement(By.className("phone")).sendKeys(phonenumber);
